 ...
 *
 * The role describes who emerges when the sign's mode of development operates
 * through the house's arena.
 *
 * Prefer compound archetypes ("A / B") because two complementary roles usually
 * communicate the synthesis more clearly than a single label. The two terms
 * should contribute distinct information rather than function as synonyms.
 *
 * Strong compounds often describe a developmental sequence:
 *
 *   Questioner / Investigator  → ask, then uncover
 *   Dreamer / Creator          → imagine, then make
 *   Student / Philosopher      → learn, then synthesise
 *   Investigator / Investor    → discover value, then commit resources
 *   Carer / Keeper             → tend, then sustain
 *
 * A single role is preferable only when a second term would add no meaningful
 * information.
 */
...
export const ARCHETYPE: Record<string, ArchetypeEntry> = {
  ...
  "Gemini/10": {
    role: "Communicator / Spokesperson",
    why:
  ...
  "Cancer/2": {
    role: "Provider / Security Builder",
    why:
  ...
  "Leo/4": {
    role: "Homemaker / Pillar",
    why:
      "The fourth house is home, roots and the private foundation; Leo develops there by becoming a defining presence within that foundation — someone who gives their private world identity, continuity and a centre around which others can gather.",
  },
  ...
  "Virgo/12": {
    role: "Interpreter / Pattern Finder",
    why:
  ...
  "Libra/11": {
    role: "Diplomat / Coalition Builder",
    why:
  ...
  "Sagittarius/8": {
    role: "Investigator / Truth Seeker",
    why:
  ...
  "Capricorn/7": {
    ...
    why:
      "The seventh house requires commitments between equals; Capricorn develops there by putting its name behind commitments — defining responsibilities, accepting obligations and remaining accountable when an agreement acquires real consequences.",
  },

  "Capricorn/8": {
    role: "Manager / Trustee",
    why:
  ...
  "Capricorn/11": {
    role: "Organizer / Institution Builder",
    why:
  ...
  "Aquarius/6": {
    role: "Problem Solver / Systems Designer",
    why:
